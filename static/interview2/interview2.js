...
(function () {
  ...
  function init() {
    el = {
      serverUrl:       document.getElementById('interview2-server-url'),
      analyzeBtn:      document.getElementById('interview2-analyze-btn'),
      analyzeIcon:     document.getElementById('interview2-analyze-icon'),
      analyzeLabel:    document.getElementById('interview2-analyze-label'),
      clearBtn:        document.getElementById('interview2-clear-btn'),
      placeholder:     document.getElementById('interview2-placeholder'),
      thinking:        document.getElementById('interview2-thinking'),
      responseContent: document.getElementById('interview2-response-content'),
      transcriptText:  document.getElementById('interview2-transcript-text'),
      transcriptPart:  document.getElementById('interview2-transcript-partial'),
      transcriptPh:    document.getElementById('interview2-transcript-placeholder'),
      transcriptScroll:document.getElementById('interview2-transcript-scroll'),
    };
